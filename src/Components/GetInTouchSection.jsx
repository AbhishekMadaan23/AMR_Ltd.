...
export default function GetInTouchSection() {
  const url =
    "https://www.mining.com/wp-content/uploads/2022/08/scrap-metal.jpeg";

  const [agreed, setAgreed] = useState(false);
  const [state, handleSubmit] = useForm("mgegagrn");
  if (state.succeeded) {
    return (
  ...
  return (
    <div
      className=" px-6 py-24 sm:py-32 lg:px-8 bg-cover bg-center "
      style={{
    ...
    >
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-wider leading-7 text-gray-700 sm:text-4xl">
          Contact Us
        </h2>
