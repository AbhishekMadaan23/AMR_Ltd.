...
const OurServices = () => {
  return (
    <section className=" w-[80vw] mx-auto pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              <span className="mb-2 block text-lg text-green-700 font-semibold text-primary">
                Our Services
              </span>
              ...
              <p className="text-base text-body-color dark:text-dark-6">
                "From efficient scrap metal collection to responsible recycling
                solutions, we are your trusted partner for sustainable waste
        ...
        <div className="-mx-4 flex flex-wrap">
          <ServiceCard
            ...
            details="We offer efficient and reliable collection services, utilizing our fleet of specialized vehicles to pick up scrap metal from your location, whether you're a construction site, manufacturing facility, or individual homeowner."
            icon={
              <svg
                width="36"
                height="36"
            ...
            // url={
            //   "https://th.bing.com/th/id/R.7698bbc80452e66e1af2e15b49690b7d?rik=NLwhD9saSWaR9g&riu=http%3a%2f%2fclipart-library.com%2fnewhp%2f112-1120222_steel-clipart-metal-scrap-scrap-png-download.png&ehk=CZwJeGmNCYJ%2b8nGF%2fHGUvdh6kcCXuWM94%2bpz%2fQk%2bWbk%3d&risl=&pid=ImgRaw&r=0"
            // }
            url={
              "https://i.pinimg.com/564x/88/fc/66/88fc669fa42aa3e29272afa0d5c36fa3.jpg"
            }
          />
          <ServiceCard
            title="Metal Processing"
            details="Our advanced processing techniques ensure that various types of scrap metal are sorted, segregated, and processed efficiently, maximizing recovery rates while adhering to strict environmental standards."
            icon={
              <svg
                width="36"
                height="36"
            ...
            url={
              "https://th.bing.com/th/id/OIP.S7J8bMguxzihD1v_hL84awHaG0?rs=1&pid=ImgDetMain"
            }
          />
          <ServiceCard
            title="Metal Recycling"
            details=" As champions of environmental sustainability, we prioritize responsible recycling of scrap metal, partnering with accredited facilities to minimize waste and reduce the burden on landfills."
            icon={
              <svg
                width="36"
                height="36"
            ...
            url={
              "https://www.recyclereminders.com/img/lg/S/recycle-metal-label-s-4991.png"
            }
          />
          <ServiceCard
            title="On-Site Container Solutions"
            details="We provide convenient on-site container solutions for businesses generating large volumes of scrap metal, offering a range of container sizes and flexible scheduling options to streamline collection and storage processes."
            icon={
              <svg
                width="36"
                height="36"
            ...
            // url={
            //   "https://le-cdn.hibuwebsites.com/b91753b32a1b460dbc48172739193c54/dms3rep/multi/opt/Capture-1920w.PNG"
            // }
            url={
              "https://i.pinimg.com/564x/68/df/f3/68dff3919e04a56c4866c49949c18825.jpg"
            }
          />
          <ServiceCard
            title="Customized Solutions"
            details="Our personalized approach means that we work closely with each client to develop customized solutions tailored to their specific requirements, goals, timeline, and budget."
            icon={
              <svg
                width="36"
                height="36"
            ...
            url={
              "https://www.recursionco.com/uploads/5/6/4/1/56416097/customize_orig.jpg"
            }
          />
          <ServiceCard
            title="Environmental Compliance"
            details=" Operating in full compliance with relevant regulations and standards, we ensure that our processes minimize environmental impact and promote sustainability, providing peace of mind to our clients regarding responsible waste management practices."
            icon={
              <svg
                width="36"
                height="36"
            ...
            url={
              "https://img.freepik.com/free-psd/paper-craft-design-recycle-icon_53876-22215.jpg?w=740&t=st=1707518978~exp=1707519578~hmac=93f2b955bfcc5cd56affa598652e13af41375f06246952bbc707161e95bc7e3f"
            }
          />
        </div>
      </div>
...
const ServiceCard = ({ url, title, details }) => {
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-[20px] bg-white p-10 shadow-md hover:shadow-xl dark:bg-dark-2 md:px-7 xl:px-10">
